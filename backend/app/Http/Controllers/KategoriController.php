...
class KategoriController extends Controller
{
    ...
    public function store(Request $request)
    {
        $rules = [
            ...
            'field_satu' => 'required|string|max:258',
            'field_dua' => 'required|string|max:258',
        ];

        $messages = [
            'nama_kategori.required' => 'Nama kategori is required',
            'field_satu.required' => 'Field Satu is required',
            'field_dua.required' => 'Field dua is required',
        ];
        ...
        try {
            ...
            Kategori::create([
                ...
                'field_satu' => $request->input('field_satu'),
                'field_dua' => $request->input('field_dua'),
            ]);
