  ...
  <div className="card shadow mb-4">
    ...
    <div className="card-body">
      <form>
        ...
        <p className='fw-bold'>Field Satu</p>
        <input type='text' name='field_satu' onChange={handleChange} value={formData.field_satu} className='form-control' required></input>
        <p className='fw-bold'>Field  Dua</p>
        <input type='text' name='field_dua' onChange={handleChange} value={formData.field_dua} className='form-control' required></input>
      </form>
    </div>
  </div>
</div>
