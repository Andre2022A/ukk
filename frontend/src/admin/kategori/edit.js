        ...
        <div className="card shadow mb-4">
          ...
          <div className="card-body">
            <form>
              ...
              <input type='text' name='fiel_satu' onChange={handleChange} value={formData.field_satu} className='form-control'></input>
              <p className='fw-bold'> Field Dua</p>
              <input type='text' name='field_dua' onChange={handleChange} value={formData.field_dua} className='form-control'></input>
            </form>
          </div>
        </div>
      </div>
